...
set(Qt53DQuickRender_VERSION_STRING 5.13.0)
...
function(_qt5_3DQuickRender_process_prl_file prl_file_location Configuration lib_deps link_flags)
    ...
    get_filename_component(_qt5_install_libs "${_qt53DQuickRender_install_prefix}/lib" ABSOLUTE)
        ...
        foreach(_flag ${_static_depends})
            ...
            if(_flag MATCHES "^-l(.*)$")
                ...
                elseif(_lib MATCHES "^pthread$")
                    ...
                    if(_search_paths)
                        find_library(_Qt53DQuickRender_${Configuration}_${_lib}_PATH ${_lib} HINTS ${_search_paths} NO_DEFAULT_PATH)
                    endif()
                    find_library(_Qt53DQuickRender_${Configuration}_${_lib}_PATH ${_lib})
...
macro(_populate_3DQuickRender_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if(NOT CMAKE_VERSION VERSION_LESS "3.13")
        set_target_properties(Qt5::3DQuickRender PROPERTIES
            "INTERFACE_LINK_OPTIONS" "${_Qt53DQuickRender_STATIC_${Configuration}_LINK_FLAGS}"
        )
    endif()
...
if (NOT TARGET Qt5::3DQuickRender)
    ...
    set(Qt53DQuickRender_PRIVATE_INCLUDE_DIRS
        "${_qt53DQuickRender_install_prefix}/include/Qt3DQuickRender/5.13.0"
        "${_qt53DQuickRender_install_prefix}/include/Qt3DQuickRender/5.13.0/Qt3DQuickRender"
    )
    ...
    foreach(_module_dep ${_Qt53DQuickRender_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.13.0 ${_Qt53DQuickRender_FIND_VERSION_EXACT}
    ...
    if(NOT Qt5_EXCLUDE_STATIC_DEPENDENCIES)
        _qt5_3DQuickRender_process_prl_file(
            "${_qt53DQuickRender_install_prefix}/lib/Qt53DQuickRenderd.prl" DEBUG
            _Qt53DQuickRender_STATIC_DEBUG_LIB_DEPENDENCIES
            _Qt53DQuickRender_STATIC_DEBUG_LINK_FLAGS
        )

        _qt5_3DQuickRender_process_prl_file(
            "${_qt53DQuickRender_install_prefix}/lib/Qt53DQuickRender.prl" RELEASE
