...
set(Qt5Bluetooth_VERSION_STRING 5.13.0)
...
function(_qt5_Bluetooth_process_prl_file prl_file_location Configuration lib_deps link_flags)
    ...
    get_filename_component(_qt5_install_libs "${_qt5Bluetooth_install_prefix}/lib" ABSOLUTE)
        ...
        foreach(_flag ${_static_depends})
            ...
            if(_flag MATCHES "^-l(.*)$")
                ...
                elseif(_lib MATCHES "^pthread$")
                    ...
                    if(_search_paths)
                        find_library(_Qt5Bluetooth_${Configuration}_${_lib}_PATH ${_lib} HINTS ${_search_paths} NO_DEFAULT_PATH)
                    endif()
                    find_library(_Qt5Bluetooth_${Configuration}_${_lib}_PATH ${_lib})
...
macro(_populate_Bluetooth_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if(NOT CMAKE_VERSION VERSION_LESS "3.13")
        set_target_properties(Qt5::Bluetooth PROPERTIES
            "INTERFACE_LINK_OPTIONS" "${_Qt5Bluetooth_STATIC_${Configuration}_LINK_FLAGS}"
        )
    endif()
...
if (NOT TARGET Qt5::Bluetooth)
    ...
    set(Qt5Bluetooth_PRIVATE_INCLUDE_DIRS
        "${_qt5Bluetooth_install_prefix}/include/QtBluetooth/5.13.0"
        "${_qt5Bluetooth_install_prefix}/include/QtBluetooth/5.13.0/QtBluetooth"
    )
    ...
    foreach(_module_dep ${_Qt5Bluetooth_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.13.0 ${_Qt5Bluetooth_FIND_VERSION_EXACT}
    ...
    if(NOT Qt5_EXCLUDE_STATIC_DEPENDENCIES)
        _qt5_Bluetooth_process_prl_file(
            "${_qt5Bluetooth_install_prefix}/lib/Qt5Bluetoothd.prl" DEBUG
            _Qt5Bluetooth_STATIC_DEBUG_LIB_DEPENDENCIES
            _Qt5Bluetooth_STATIC_DEBUG_LINK_FLAGS
        )

        _qt5_Bluetooth_process_prl_file(
            "${_qt5Bluetooth_install_prefix}/lib/Qt5Bluetooth.prl" RELEASE
