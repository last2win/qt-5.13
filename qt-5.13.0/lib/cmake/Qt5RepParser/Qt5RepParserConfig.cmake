...
function(_qt5_RepParser_process_prl_file prl_file_location Configuration lib_deps link_flags)
    ...
    get_filename_component(_qt5_install_libs "${_qt5RepParser_install_prefix}/lib" ABSOLUTE)
        ...
        foreach(_flag ${_static_depends})
            ...
            if(_flag MATCHES "^-l(.*)$")
                ...
                elseif(_lib MATCHES "^pthread$")
                    ...
                    if(_search_paths)
                        find_library(_Qt5RepParser_${Configuration}_${_lib}_PATH ${_lib} HINTS ${_search_paths} NO_DEFAULT_PATH)
                    endif()
                    find_library(_Qt5RepParser_${Configuration}_${_lib}_PATH ${_lib})
...
if (NOT TARGET Qt5::RepParser)
    ...
    if(NOT Qt5_EXCLUDE_STATIC_DEPENDENCIES)
        _qt5_RepParser_process_prl_file(
            "${_qt5RepParser_install_prefix}/lib/Qt5RepParserd.prl" DEBUG
            _Qt5RepParser_STATIC_DEBUG_LIB_DEPENDENCIES
            _Qt5RepParser_STATIC_DEBUG_LINK_FLAGS
        )

        _qt5_RepParser_process_prl_file(
            "${_qt5RepParser_install_prefix}/lib/Qt5RepParser.prl" RELEASE
