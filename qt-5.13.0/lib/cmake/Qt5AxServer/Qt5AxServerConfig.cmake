...
set(Qt5AxServer_VERSION_STRING 5.13.0)
...
function(_qt5_AxServer_process_prl_file prl_file_location Configuration lib_deps link_flags)
    ...
    get_filename_component(_qt5_install_libs "${_qt5AxServer_install_prefix}/lib" ABSOLUTE)
        ...
        foreach(_flag ${_static_depends})
            ...
            if(_flag MATCHES "^-l(.*)$")
                ...
                elseif(_lib MATCHES "^pthread$")
                    ...
                    if(_search_paths)
                        find_library(_Qt5AxServer_${Configuration}_${_lib}_PATH ${_lib} HINTS ${_search_paths} NO_DEFAULT_PATH)
                    endif()
                    find_library(_Qt5AxServer_${Configuration}_${_lib}_PATH ${_lib})
...
macro(_populate_AxServer_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if(NOT CMAKE_VERSION VERSION_LESS "3.13")
        set_target_properties(Qt5::AxServer PROPERTIES
            "INTERFACE_LINK_OPTIONS" "${_Qt5AxServer_STATIC_${Configuration}_LINK_FLAGS}"
        )
    endif()
    ...
    foreach(_module_dep ${_Qt5AxServer_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.13.0 ${_Qt5AxServer_FIND_VERSION_EXACT}
