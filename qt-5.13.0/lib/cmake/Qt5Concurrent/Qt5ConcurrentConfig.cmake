...
function(_qt5_Concurrent_process_prl_file prl_file_location Configuration lib_deps link_flags)
    ...
    get_filename_component(_qt5_install_libs "${_qt5Concurrent_install_prefix}/lib" ABSOLUTE)
        ...
        foreach(_flag ${_static_depends})
            ...
            if(_flag MATCHES "^-l(.*)$")
                ...
                elseif(_lib MATCHES "^pthread$")
                    ...
                    if(_search_paths)
                        find_library(_Qt5Concurrent_${Configuration}_${_lib}_PATH ${_lib} HINTS ${_search_paths} NO_DEFAULT_PATH)
                    endif()
                    find_library(_Qt5Concurrent_${Configuration}_${_lib}_PATH ${_lib})
...
macro(_populate_Concurrent_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if(NOT CMAKE_VERSION VERSION_LESS "3.13")
        set_target_properties(Qt5::Concurrent PROPERTIES
            "INTERFACE_LINK_OPTIONS" "${_Qt5Concurrent_STATIC_${Configuration}_LINK_FLAGS}"
        )
    endif()
...
if (NOT TARGET Qt5::Concurrent)
    ...
    if(NOT Qt5_EXCLUDE_STATIC_DEPENDENCIES)
        _qt5_Concurrent_process_prl_file(
            "${_qt5Concurrent_install_prefix}/lib/Qt5Concurrentd.prl" DEBUG
            _Qt5Concurrent_STATIC_DEBUG_LIB_DEPENDENCIES
            _Qt5Concurrent_STATIC_DEBUG_LINK_FLAGS
        )

        _qt5_Concurrent_process_prl_file(
            "${_qt5Concurrent_install_prefix}/lib/Qt5Concurrent.prl" RELEASE
