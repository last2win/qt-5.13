...
set(Qt5AxBase_VERSION_STRING 5.13.0)
...
function(_qt5_AxBase_process_prl_file prl_file_location Configuration lib_deps link_flags)
    ...
    get_filename_component(_qt5_install_libs "${_qt5AxBase_install_prefix}/lib" ABSOLUTE)
        ...
        foreach(_flag ${_static_depends})
            ...
            if(_flag MATCHES "^-l(.*)$")
                ...
                elseif(_lib MATCHES "^pthread$")
                    ...
                    if(_search_paths)
                        find_library(_Qt5AxBase_${Configuration}_${_lib}_PATH ${_lib} HINTS ${_search_paths} NO_DEFAULT_PATH)
                    endif()
                    find_library(_Qt5AxBase_${Configuration}_${_lib}_PATH ${_lib})
...
macro(_populate_AxBase_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if(NOT CMAKE_VERSION VERSION_LESS "3.13")
        set_target_properties(Qt5::AxBase PROPERTIES
            "INTERFACE_LINK_OPTIONS" "${_Qt5AxBase_STATIC_${Configuration}_LINK_FLAGS}"
        )
    endif()
...
if (NOT TARGET Qt5::AxBase)
    ...
    set(Qt5AxBase_PRIVATE_INCLUDE_DIRS
        "${_qt5AxBase_install_prefix}/include/ActiveQt/5.13.0"
        "${_qt5AxBase_install_prefix}/include/ActiveQt/5.13.0/ActiveQt"
    )
    ...
    foreach(_module_dep ${_Qt5AxBase_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.13.0 ${_Qt5AxBase_FIND_VERSION_EXACT}
