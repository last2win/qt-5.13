...
set(Qt53DAnimation_VERSION_STRING 5.13.0)
...
function(_qt5_3DAnimation_process_prl_file prl_file_location Configuration lib_deps link_flags)
    ...
    get_filename_component(_qt5_install_libs "${_qt53DAnimation_install_prefix}/lib" ABSOLUTE)
        ...
        foreach(_flag ${_static_depends})
            ...
            if(_flag MATCHES "^-l(.*)$")
                ...
                elseif(_lib MATCHES "^pthread$")
                    ...
                    if(_search_paths)
                        find_library(_Qt53DAnimation_${Configuration}_${_lib}_PATH ${_lib} HINTS ${_search_paths} NO_DEFAULT_PATH)
                    endif()
                    find_library(_Qt53DAnimation_${Configuration}_${_lib}_PATH ${_lib})
...
if (NOT TARGET Qt5::3DAnimation)
    ...
    set(Qt53DAnimation_PRIVATE_INCLUDE_DIRS
        "${_qt53DAnimation_install_prefix}/include/Qt3DAnimation/5.13.0"
        "${_qt53DAnimation_install_prefix}/include/Qt3DAnimation/5.13.0/Qt3DAnimation"
    )
    ...
    foreach(_module_dep ${_Qt53DAnimation_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.13.0 ${_Qt53DAnimation_FIND_VERSION_EXACT}
    ...
    if(NOT Qt5_EXCLUDE_STATIC_DEPENDENCIES)
        _qt5_3DAnimation_process_prl_file(
            "${_qt53DAnimation_install_prefix}/lib/Qt53DAnimationd.prl" DEBUG
            _Qt53DAnimation_STATIC_DEBUG_LIB_DEPENDENCIES
            _Qt53DAnimation_STATIC_DEBUG_LINK_FLAGS
        )

        _qt5_3DAnimation_process_prl_file(
            "${_qt53DAnimation_install_prefix}/lib/Qt53DAnimation.prl" RELEASE
