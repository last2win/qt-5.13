...
function(_qt5_DataVisualization_process_prl_file prl_file_location Configuration lib_deps link_flags)
    set(_lib_deps)
    set(_link_flags)

    get_filename_component(_qt5_install_libs "${_qt5DataVisualization_install_prefix}/lib" ABSOLUTE)
        ...
        foreach(_flag ${_static_depends})
            ...
            if(_flag MATCHES "^-l(.*)$")
                ...
                elseif(_lib MATCHES "^pthread$")
                    ...
                    if(_search_paths)
                        find_library(_Qt5DataVisualization_${Configuration}_${_lib}_PATH ${_lib} HINTS ${_search_paths} NO_DEFAULT_PATH)
                    endif()
                    find_library(_Qt5DataVisualization_${Configuration}_${_lib}_PATH ${_lib})
                    mark_as_advanced(_Qt5DataVisualization_${Configuration}_${_lib}_PATH)
                    if(_Qt5DataVisualization_${Configuration}_${_lib}_PATH)
                        list(APPEND _lib_deps
                            ${_Qt5DataVisualization_${Configuration}_${_lib}_PATH}
                        )
                    else()
...
macro(_populate_DataVisualization_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(_deps
        ...
        ${_Qt5DataVisualization_STATIC_${Configuration}_LIB_DEPENDENCIES}
    )
    ...
    if(NOT CMAKE_VERSION VERSION_LESS "3.13")
        set_target_properties(Qt5::DataVisualization PROPERTIES
            "INTERFACE_LINK_OPTIONS" "${_Qt5DataVisualization_STATIC_${Configuration}_LINK_FLAGS}"
        )
    endif()
...
if (NOT TARGET Qt5::DataVisualization)
    ...
    set(Qt5DataVisualization_PRIVATE_INCLUDE_DIRS
        "${_qt5DataVisualization_install_prefix}/include/QtDataVisualization/5.13.0"
        "${_qt5DataVisualization_install_prefix}/include/QtDataVisualization/5.13.0/QtDataVisualization"
    )
    ...
    if(NOT Qt5_EXCLUDE_STATIC_DEPENDENCIES)
        _qt5_DataVisualization_process_prl_file(
            "${_qt5DataVisualization_install_prefix}/lib/Qt5DataVisualizationd.prl" DEBUG
            _Qt5DataVisualization_STATIC_DEBUG_LIB_DEPENDENCIES
            _Qt5DataVisualization_STATIC_DEBUG_LINK_FLAGS
        )

        _qt5_DataVisualization_process_prl_file(
            "${_qt5DataVisualization_install_prefix}/lib/Qt5DataVisualization.prl" RELEASE
            _Qt5DataVisualization_STATIC_RELEASE_LIB_DEPENDENCIES
            _Qt5DataVisualization_STATIC_RELEASE_LINK_FLAGS
        )
    endif()
