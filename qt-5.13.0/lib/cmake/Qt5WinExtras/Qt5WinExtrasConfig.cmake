...
set(Qt5WinExtras_VERSION_STRING 5.13.0)
...
function(_qt5_WinExtras_process_prl_file prl_file_location Configuration lib_deps link_flags)
    set(_lib_deps)
    set(_link_flags)

    get_filename_component(_qt5_install_libs "${_qt5WinExtras_install_prefix}/lib" ABSOLUTE)
        ...
        foreach(_flag ${_static_depends})
            ...
            if(_flag MATCHES "^-l(.*)$")
                ...
                elseif(_lib MATCHES "^pthread$")
                    ...
                    if(_search_paths)
                        find_library(_Qt5WinExtras_${Configuration}_${_lib}_PATH ${_lib} HINTS ${_search_paths} NO_DEFAULT_PATH)
                    endif()
                    find_library(_Qt5WinExtras_${Configuration}_${_lib}_PATH ${_lib})
                    mark_as_advanced(_Qt5WinExtras_${Configuration}_${_lib}_PATH)
                    if(_Qt5WinExtras_${Configuration}_${_lib}_PATH)
                        list(APPEND _lib_deps
                            ${_Qt5WinExtras_${Configuration}_${_lib}_PATH}
                        )
                    else()
...
macro(_populate_WinExtras_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(_deps
        ...
        ${_Qt5WinExtras_STATIC_${Configuration}_LIB_DEPENDENCIES}
    )
    ...
    if(NOT CMAKE_VERSION VERSION_LESS "3.13")
        set_target_properties(Qt5::WinExtras PROPERTIES
            "INTERFACE_LINK_OPTIONS" "${_Qt5WinExtras_STATIC_${Configuration}_LINK_FLAGS}"
        )
    endif()
...
if (NOT TARGET Qt5::WinExtras)
    ...
    set(Qt5WinExtras_PRIVATE_INCLUDE_DIRS
        "${_qt5WinExtras_install_prefix}/include/QtWinExtras/5.13.0"
        "${_qt5WinExtras_install_prefix}/include/QtWinExtras/5.13.0/QtWinExtras"
    )
    ...
    foreach(_module_dep ${_Qt5WinExtras_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.13.0 ${_Qt5WinExtras_FIND_VERSION_EXACT}
    ...
    if(NOT Qt5_EXCLUDE_STATIC_DEPENDENCIES)
        _qt5_WinExtras_process_prl_file(
            "${_qt5WinExtras_install_prefix}/lib/Qt5WinExtrasd.prl" DEBUG
            _Qt5WinExtras_STATIC_DEBUG_LIB_DEPENDENCIES
            _Qt5WinExtras_STATIC_DEBUG_LINK_FLAGS
        )

        _qt5_WinExtras_process_prl_file(
            "${_qt5WinExtras_install_prefix}/lib/Qt5WinExtras.prl" RELEASE
            _Qt5WinExtras_STATIC_RELEASE_LIB_DEPENDENCIES
            _Qt5WinExtras_STATIC_RELEASE_LINK_FLAGS
        )
    endif()
