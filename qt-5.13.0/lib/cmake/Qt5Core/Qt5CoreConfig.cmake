...
function(_qt5_Core_process_prl_file prl_file_location Configuration lib_deps link_flags)
    ...
    get_filename_component(_qt5_install_libs "${_qt5Core_install_prefix}/lib" ABSOLUTE)
...
macro(_populate_Core_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if(NOT CMAKE_VERSION VERSION_LESS "3.13")
        set_target_properties(Qt5::Core PROPERTIES
            "INTERFACE_LINK_OPTIONS" "${_Qt5Core_STATIC_${Configuration}_LINK_FLAGS}"
        )
    endif()
...
if (NOT TARGET Qt5::Core)
    ...
    set(Qt5Core_PRIVATE_INCLUDE_DIRS
        "${_qt5Core_install_prefix}/include/QtCore/5.13.0"
        "${_qt5Core_install_prefix}/include/QtCore/5.13.0/QtCore"
    )
    ...
    if(NOT Qt5_EXCLUDE_STATIC_DEPENDENCIES)
        _qt5_Core_process_prl_file(
            "${_qt5Core_install_prefix}/lib/Qt5Cored.prl" DEBUG
            _Qt5Core_STATIC_DEBUG_LIB_DEPENDENCIES
            _Qt5Core_STATIC_DEBUG_LINK_FLAGS
        )

        _qt5_Core_process_prl_file(
            "${_qt5Core_install_prefix}/lib/Qt5Core.prl" RELEASE
